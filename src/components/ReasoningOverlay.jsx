            ...
            >
                    ...
                    {logicSteps.map((s, i) => (
                        <div key={i} style={{
                            ...
                            <div className="font-mono" style={{
                                ...
                                border: `1px solid ${i === step ? 'var(--accent-primary)' : 'var(--bg-panel-border)'}`,
                                borderRadius: '4px',
                                fontWeight: 800
                            }}>
                                {i + 1}
                            </div>
                            <div style={{ fontSize: '0.75rem', color: i === step ? '#fff' : 'var(--text-muted)', lineHeight: '1.5', fontWeight: i === step ? 500 : 400 }}>
                                {s}
                            </div>
                        </div>
                    ))}
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        ...
                        <span style={{ fontSize: '0.55rem', color: 'var(--text-muted)', fontWeight: 700, letterSpacing: '1px' }}>CONFIDENCE</span>
                    </div>
