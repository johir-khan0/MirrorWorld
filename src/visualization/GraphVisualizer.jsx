    ...
    return (
        <div ref={containerRef} style={{ width: '100%', height: '100%', position: 'relative' }}>
            ...
            <div 
                ...
                title={isLegendMinimized ? "Expand Map Key" : "Minimize Map Key"}
                style={{
                    position: 'absolute',
                    bottom: '2rem',
                    right: '2rem',
                    ...
                    padding: isLegendMinimized ? '0.6rem' : '1rem',
                    borderRadius: '8px',
                    pointerEvents: 'auto',
                    userSelect: 'none',
                    cursor: 'pointer',
                    transition: 'all 0.3s ease',
                    minWidth: isLegendMinimized ? 'auto' : '200px'
            }}>
                {isLegendMinimized ? (
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        <MapIcon size={16} color="var(--accent-primary)" />
                        <span style={{ fontSize: '0.7rem', color: '#ccc', fontFamily: 'var(--font-mono)', fontWeight: 700 }}>KEY</span>
                    </div>
                ) : (
                    <>
                        <div style={{ fontFamily: 'var(--font-mono)', fontSize: '0.7rem', color: '#888', marginBottom: '0.5rem', textTransform: 'uppercase', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <span>Map Key</span>
                            <ChevronDown size={14} />
                        </div>
